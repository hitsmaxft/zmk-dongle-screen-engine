...
def verify(output,api_only=False):
    ...
    for w,h in ((280,240),(240,280),(240,240)):
        ...
        calls += [['dte_preview_set_filter',[1]],['dte_preview_set_filter_corner_radius',[43]],['dte_render',[5300]],['dte_render',[5400]],['dte_preview_set_filter_corner_radius',[24]],['dte_preview_set_filter',[0]],['dte_render',[5500]]]
    expected=[]
