...
`dte_preview_set_filter_corner_radius(px)`; the preview shell exposes the
same radius control without reloading WASM or resetting Theme state. It reports the number of inspected
